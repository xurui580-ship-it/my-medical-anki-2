...
'use server';
/**
 * @fileOverview Defines server actions and Genkit flows.
 * This file contains the Genkit flow for extracting Q&A pairs from a document,
 * as well as the server action that components can call to trigger it.
 */

'use server';
/**
 * @fileOverview Defines the client-callable server action and the Genkit flow 
 * for extracting Q&A from a document. All related logic is co-located in this
 * file to work seamlessly with Next.js Server Actions.
 */
...
export async function extractQaFromDocument(
  ...
  // Directly call the flow defined in the same file.
  // The Genkit + Next.js plugin will handle proxying this call correctly.

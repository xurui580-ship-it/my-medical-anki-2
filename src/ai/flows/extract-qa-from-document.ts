'use server';
/**
 * @fileOverview Defines and exposes a Genkit flow for extracting Q&A from a document.
 * This file contains the full end-to-end logic, from the client-callable
 * function to the AI prompt and flow definition.
 */
...
export async function extractQaFromDocument(
  ...
  // Directly call the flow defined in this file.

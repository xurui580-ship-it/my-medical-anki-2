'use server';
/**
 * @fileOverview Genkit initialization and flow definitions.
 * This file initializes the Genkit AI instance and defines all the AI flows
 * used in the application. It is intended to be loaded by the Genkit
 * developer server.
 */
...
// --- Flow and Schema Definitions ---

// Schemas are defined here to be used by the flow and can be imported
// by the client-side components for type safety.

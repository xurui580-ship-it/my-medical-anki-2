 ...
 * This file initializes the Genkit AI instance and defines all the flows
 * and prompts for the application.
 */
...
import { ExtractQaFromDocumentInputSchema, ExtractQaFromDocumentOutputSchema } from './types';
